...
#if (1 == CASE_TEST	)					// 0:XOR, 1:MNIST,FCN 2:MNIST CNN
...
void NN_model_c::NN_model_init_cnn(Simu_para_c *p_simu_para0)
{
	...
	if (0!= func_mnist_cnn_wei_init(fn_str_0,mnist_cnn_wei0_0[0],mnist_cnn_bia0_0,ci_v0[0],co_v0[0],ker_0[0]*ker_0[0],0))
	{
	...
	if (0!= func_mnist_cnn_wei_init(fn_str_1,mnist_cnn_wei0_1[0],mnist_cnn_bia0_1,ci_v0[1],co_v0[1],ker_0[1]*ker_0[1],0))
	{
